...
{
    public partial class VatOutstandingPayment : Form
    {
        BlInvoice blInvoice = new BlInvoice();

        public VatOutstandingPayment()
        {
            InitializeComponent();
        }
        ...
        {
            DataTable dt = blInvoice.GetVatOutstandingPayments();
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
                ...
                e.RowIndex >= 0)
            {
                ...
                blInvoice.UpdateVatPaymentStatus(Convert.ToInt32(id));
                BindGrid();
            }
        }
